...
from mvgrid.paths import NOVI_SAD_GENERATED_DIR, NOVI_SAD_MODEL_DIR, display_path


STATIONS = NOVI_SAD_GENERATED_DIR / "novi_sad_seeded_substations.json"
INVENTORY = NOVI_SAD_GENERATED_DIR / "novi_sad_synthetic_transformers.csv"
ASSIGNMENTS = NOVI_SAD_GENERATED_DIR / "novi_sad_synthetic_feeder_assignments.csv"
FEEDERS = NOVI_SAD_GENERATED_DIR / "novi_sad_inferred_feeders.geojson"
LEGACY_ROUTES = NOVI_SAD_GENERATED_DIR / "novi_sad_legacy_35kv_routes.geojson"
FEEDER_SUMMARY = NOVI_SAD_GENERATED_DIR / "novi_sad_inferred_feeders_summary.json"
OUTPUT_NET = NOVI_SAD_MODEL_DIR / "ppnet_novi_sad.json"
OUTPUT_MANIFEST = NOVI_SAD_MODEL_DIR / "novi_sad_model_manifest.json"
OUTPUT_RESULTS = NOVI_SAD_MODEL_DIR / "novi_sad_powerflow_results.json"
INPUT_MANIFEST = NOVI_SAD_GENERATED_DIR / "novi_sad_input_manifest.json"
...
def main():
    ...
    manifest = {
        ...
        "network_file": display_path(OUTPUT_NET),
        "station_source": display_path(STATIONS),
        "load_source": display_path(INVENTORY),
        "assignment_source": display_path(ASSIGNMENTS),
