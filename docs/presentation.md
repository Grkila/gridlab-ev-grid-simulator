...
User chose estimates instead of continuing SN sensitivity runs. Q2 now compares equal8h windows from frozen June profile:08-16 539.947MWh NN headroom,16-24 456.829MWh,00-08 614.688MWh. Work/evening ratio1.18195, not a proven fleet-capacity increase. Q4 states dedicated MV service with its own transformer can bypass the old residential LV branch; no numerical gain or physical new-substation validation is claimed.
