...
MODEL_FILES = ('benchmark.py', 'simulation.py', 'demand.py', 'network.py', 'node_aggregation.py',
...
class ContinuousCampaignService:
    ...
    def create(self, benchmark_job_id, config=None):
        ...
        request = dict(config=cfg, case_origin='llm', node_ids=sorted(b['id'] for b in fixture['blocks']), benchmark_job_id=benchmark_job_id, suite_id=result['request']['suite_id'],
